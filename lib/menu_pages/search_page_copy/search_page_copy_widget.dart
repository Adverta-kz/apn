  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<NewsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NewsRecord> searchPageCopyNewsRecordList = snapshot.data!;
                              ...
                              child: Padding(
                                ...
                                child: FutureBuilder<List<NewsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<NewsRecord> gridViewNewsRecordList =
                                        snapshot.data!;
                                    if (gridViewNewsRecordList.isEmpty) {
                                      return Image.asset(
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemCount: gridViewNewsRecordList.length,

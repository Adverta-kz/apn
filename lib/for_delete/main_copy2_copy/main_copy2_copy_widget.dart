...
import 'main_copy2_copy_model.dart';
export 'main_copy2_copy_model.dart';

class MainCopy2CopyWidget extends StatefulWidget {
  const MainCopy2CopyWidget({
    Key? key,
  ...
  @override
  _MainCopy2CopyWidgetState createState() => _MainCopy2CopyWidgetState();
}

class _MainCopy2CopyWidgetState extends State<MainCopy2CopyWidget> {
  late MainCopy2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainCopy2CopyModel());

...
class _MainWidgetState extends State<MainWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (widget.selectedChoiseChip != null &&
          widget.selectedChoiseChip != '') {
        setState(() {
          _model.choosedCat = widget.selectedChoiseChip;
        });
      }
    });
                                  ...
                                  children: [
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Приветствую! ${valueOrDefault<String>(
                                          valueOrDefault(
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            rowNewsRecord.postTitle.maybeHandleOverflow(
                                                                              maxChars: 40,
                                                                              replacement: '…',
                                                                            ),
                                                                            textAlign:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Text(
                                                                                  rowNewsRecord.numLikes.toString(),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'San Francisco',
                                                                                        color: Color(0xFFD2D2D2),
                                                                                        fontSize: 13.0,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 5.0, 0.0),
                                                                                child: Text(
                                                                                  columnNewsRecord.numLikes.toString(),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'San Francisco',
                                                                                        color: Color(0xFFD2D2D2),
                                                                                        fontSize: 13.0,
